 ...
 */
export type CliArgGroupArgs<TRequired extends boolean> = TRequired extends true
	? string[]
	: string[] | undefined;
...
> = {
	 ...
	 * arguments */
	parse:
		| ((args: CliArgGroupArgs<TRequired>) => TValue)
		| ((args: CliArgGroupArgs<TRequired>) => Promise<TValue>);
...
export type TValueFromCliArgGroup<TArgGroup> = TArgGroup extends CliArgGroup<
	infer TValue
>
	? TValue
	: never;
